...
public class ScheduleController {
    ...
    public ScheduleDTO createSchedule(@RequestBody ScheduleDTO scheduleDTO) {
        ...
        try {
            convertedSchedule = convertScheduleToScheduleDTO(
    ...
    public List<ScheduleDTO> getScheduleForPet(@PathVariable long petId) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Pet schedule with id: " + petId + " not found",
                    exception);
        }
        return schedules.stream().map(this::convertScheduleToScheduleDTO).collect(Collectors.toList());
    }
    ...
    public List<ScheduleDTO> getScheduleForEmployee(@PathVariable long employeeId) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                    "Employee schedule with employee id: " + employeeId + " not found", exception);
        }
        return schedules.stream().map(this::convertScheduleToScheduleDTO).collect(Collectors.toList());
    }
    ...
    public List<ScheduleDTO> getScheduleForCustomer(@PathVariable long customerId) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                    "Schedule with owner id " + customerId + " not found", exception);
        }
        return schedules.stream().map(this::convertScheduleToScheduleDTO).collect(Collectors.toList());
    }
}